...
public class CameraHelper {
    ...
    public void setCameraDisplayOrientation(final Activity activity,
        ...
        int rotation = getCameraDisplayOrientation(activity, cameraId);
//gjs        camera.setDisplayOrientation(rotation);
...
//        Log.i("gjs test", "orientation:"+info.orientation+" degrees:"+degrees);
        return result;
    }
